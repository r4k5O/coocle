...
class NewsletterApiTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        os.environ["COOCLE_NEWSLETTER_ADMIN_TOKEN"] = "test-admin-token"
    ...
    def test_github_stats_endpoint_requires_config(self) -> None:
        with patch("backend.main.githubmod.fetch_github_stats", side_effect=RuntimeError("GITHUB_REPO ist nicht konfiguriert.")):
